...
############################################
## Example of how to look at results for individual traits
############################################
load("GWAS_sat/frames/Bremia_raw.out")
write.table(plot_frame, "GWAS_sat/GWAS_corr_SNP_Bremia_raw.tsv", sep = "\t")
