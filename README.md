# AdvBio course 2025-2026
This repository contains code for the R&D project in the course Advanced Biotechnology 2025-2026. It is based on the publication Dijkhuizen et al., 2024:
- https://doi.org/10.1111/tpj.70405
- https://github.com/SnoekLab/Dijkhuizen_etal_2025_Drone/tree/main

SNP and other data can be found in the publication-associated repository
https://public.yoda.uu.nl/science/UU01/S5FCM9.html

## Instructions
1. Download the GWAS script from this repository.
2. Put the script into your working directory, open the script in RStudio 
...
7. Run the script. You might need to install the libraries first. Ask the instructor for help if you run into difficulties. 
